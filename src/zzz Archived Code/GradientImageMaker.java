...
public class GradientImageMaker {
	...
	public BufferedImage makeGradient(float brightness, int gradientType) {
		if(gradientType==GradientImageMaker.HARDLIGHT) {
			return makeGradient_HardLight( brightness);
		}
		if((gradientType==GradientImageMaker.MEDIUMLIGHT) || (gradientType==GradientImageMaker.MEDIUMSOFTLIGHT)) {
			return makeGradient_MediumLight( brightness);
		}
		if(gradientType==GradientImageMaker.SOFTLIGHT) {
