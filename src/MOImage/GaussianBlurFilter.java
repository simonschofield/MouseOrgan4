	...
	public static void convolveAndTranspose(Kernel kernel, int[] inPixels, int[] outPixels, int width, int height, boolean alpha, int edgeAction) {
		...
		for (int y = 0; y < height; y++) {
			...
			for (int x = 0; x < width; x++) {
				...
				int ia = alpha ? MOMaths.constrain((int)(a+0.5),0,255) : 0xff;
				int ir = MOMaths.constrain((int)(r+0.5),0,255);
				int ig = MOMaths.constrain((int)(g+0.5),0,255);
				int ib = MOMaths.constrain((int)(b+0.5),0,255);
