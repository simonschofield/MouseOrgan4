...
public class RenderSaver {
	...
	MainDocumentRenderTarget renderTarget;
	...
	public RenderSaver(String baseName, MainDocumentRenderTarget rt) {
		this.baseName = baseName;
		this.renderTarget = rt;
		
	}

	public void createSubDirectory(boolean usinglayer) {
		useLayers = usinglayer;
		useSubDirectory = true;
		subDirectory = MOStringUtils.createDirectory(MOUtilGlobals.userSessionPath, baseName, true);
	}
	...
	public void saveImageFile() {
		if (useSubDirectory) {
			if(useLayers) {
				...
				renderTarget.saveRenderToFile(fullPathAndName);
			}
		} else {

			String path = MOUtilGlobals.userSessionPath;
	...
	void saveLayer(boolean clearImage) {
		...
		if(clearImage) renderTarget.clearImage();
	}
